...
const services = [
  {
    ...
    description:
      "Stratégies digitales innovantes pour amplifier votre présence en ligne et engager votre audience.",
    icon: "TrendingUp",
  ...
  },
  {
    ...
    description:
      "Production audiovisuelle professionnelle pour captiver votre audience avec des contenus visuels impactants.",
    icon: "Camera",
  ...
  },
  {
    ...
    description:
      "Événements hybrides et scénographies technologiques pour créer des expériences mémorables.",
    icon: "Users",
  ...
  },
  {
    ...
    description:
      "Identité visuelle et design graphique créatif pour renforcer votre image de marque.",
    icon: "Palette",
  ...
  },
  {
    ...
    description:
      "Sites web et applications modernes avec une attention particulière à l'expérience utilisateur.",
    icon: "Code",
  ...
  },
  {
    ...
    description:
      "Solutions IA sur mesure pour optimiser vos processus et créer de nouvelles opportunités.",
    icon: "Brain",
    image: "/images/ia.svg",
