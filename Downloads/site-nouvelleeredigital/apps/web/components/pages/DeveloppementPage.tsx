      ...
      <ThemeSection variant="light" className="py-20">
        <div className="max-w-4xl mx-auto">
          <div className="max-w-3xl mx-auto space-y-6 text-lg text-foreground">
            ...
            <p>
              Notre pôle Développement Web & Numérique transforme vos besoins en solutions concrètes
      ...
      <ThemeSection variant="light" className="py-20 bg-muted">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto space-y-6 text-lg text-foreground text-center">
            ...
            <p>
              Chaque projet est pensé comme une expérience : intuitive pour l'utilisateur, robuste
              ...
              <div className="flex flex-col md:flex-row gap-6 items-start">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-lg text-foreground mb-4">
                    ...
                    Développement d'applications mobiles (React Native, Flutter). Gestion de projets
              ...
              <div className="flex flex-col md:flex-row gap-6 items-start">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-lg text-foreground mb-4">
                    ...
                    gestion, l'analyse et le reporting. Scripts d'automatisation sur mesure,
            ...
            {[
              {
                num: "1",
                title: "Cadrage",
                desc: "Analyse fonctionnelle et UX, définition des objectifs.",
              },
              {
                num: "2",
                title: "Design & Prototype",
                desc: "Wireframes, UI, validation parcours utilisateur.",
              },
              {
                num: "3",
                title: "Développement",
                desc: "Intégration front/back, connecteurs et API.",
              },
              {
                num: "4",
                title: "Tests & Sécurité",
                desc: "QA, RGPD, performances, compatibilités.",
              },
              {
                num: "5",
                title: "Déploiement & Suivi",
                desc: "Mise en ligne, maintenance, analytics.",
              },
            ].map((item, i) => (
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {[
              ...
              { category: "Automatisation / IA", items: "OpenAI, Gemini, Zapier, n8n" },
              {
                ...
                items: "OVH Cloud, Scaleway, Infomaniak, serveurs souverains UE",
              },
            ].map((item, i) => (
          ...
          <div className="overflow-x-auto">
            <table className="w-full max-w-4xl mx-auto">
              ...
              <tbody className="divide-y divide-zinc-200 dark:divide-zinc-700">
                {[
                  {
                    atout: "Développement agile & sur mesure",
                    benefice: "Solutions parfaitement adaptées.",
                  },
                  {
                    atout: "Design + technologie intégrés",
                    benefice: "Expérience fluide, cohérence UX/UI.",
                  },
                  {
                    atout: "Hébergement souverain",
                    benefice: "Sécurité et conformité RGPD garanties.",
                  },
                  {
                    atout: "Automatisation intelligente",
                    benefice: "Gain de temps et reporting constant.",
                  },
                  {
                    atout: "Support humain & suivi IA",
                    benefice: "Assistance réactive, optimisations continues.",
                  },
                ].map((row, i) => (
                  <tr
                    key={i}
