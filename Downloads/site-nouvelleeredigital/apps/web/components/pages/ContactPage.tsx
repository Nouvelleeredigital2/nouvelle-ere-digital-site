    ...
    <>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto mb-12">
            <div className="card text-center group hover:shadow-lg transition-shadow">
              ...
              <p className="text-muted-foreground">contact@nouvelleeredigital.fr</p>
            </div>

            <div className="card text-center group hover:shadow-lg transition-shadow">
              <div className="text-3xl mb-4">🌐</div>
              <h3 className="font-semibold text-foreground mb-2">Site web</h3>
              <p className="text-muted-foreground">www.nouvelleeredigital.fr</p>
            </div>
            ...
            <div className="card text-center group hover:shadow-lg transition-shadow">
              <div className="text-3xl mb-4">📍</div>
              <h3 className="font-semibold text-foreground mb-2">Agences</h3>
              <p className="text-muted-foreground">Paris · Lyon · Nantes</p>
            </div>
      ...
      <ThemeSection variant="light" className="py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto space-y-6 text-lg text-foreground text-center">
            ...
            <blockquote
              className="border-l-4 pl-6 py-4 text-muted-foreground italic text-xl"
      ...
      <ThemeSection variant="light" className="py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto space-y-6 text-lg text-foreground text-center mb-12">
            <p>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-12">
            ...
            <div className="card text-center group hover:shadow-lg transition-all hover:scale-105">
              ...
              <p className="text-muted-foreground text-sm mb-4">Scannez pour explorer</p>
              <div className="w-32 h-32 mx-auto bg-muted rounded-lg flex items-center justify-center">
                <div className="w-24 h-24 bg-background rounded-lg flex items-center justify-center">
                  <div className="text-card-foreground text-xs font-bold">QR</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <ThemeSection variant="gradient" className="py-32">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center">
            ...
            >
              <div className="text-6xl mb-4">📱</div>
              <div className="w-48 h-48 mx-auto bg-background rounded-2xl flex items-center justify-center shadow-2xl">
                <div className="w-40 h-40 bg-background rounded-xl flex items-center justify-center">
                  <div className="text-card-foreground text-2xl font-bold">QR</div>
                </div>
              </div>
              <p className="mt-4 text-lg font-semibold text-foreground">
                Scannez pour découvrir
              </p>
              <p className="text-sm text-muted-foreground">notre univers IA</p>
            </div>
          </div>
