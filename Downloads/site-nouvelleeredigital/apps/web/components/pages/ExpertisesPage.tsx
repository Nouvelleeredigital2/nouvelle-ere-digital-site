    ...
    <>
      ...
      <ThemeSection variant="gradient" className="py-32 md:py-40">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-sm uppercase tracking-wide text-zinc-500 dark:text-zinc-400 mb-4">Nos Expertises Intégrées</p>
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-semibold tracking-tight text-zinc-900 dark:text-white leading-[1.1] mb-6">
            Une approche globale,<br />créative et technologique<br />au service de votre performance.
          </h1>
        </div>
      </ThemeSection>
      ...
      <ThemeSection variant="light" className="py-20">
        <div className="max-w-4xl mx-auto">
          <div className="max-w-3xl mx-auto space-y-6 text-lg text-zinc-700 dark:text-zinc-300">
            <p>
              Chez Nouvelle Ère Digital, nous croyons qu'un projet réussi repose sur une vision unifiée.
            </p>
            <p>
              C'est pourquoi nous avons réuni, au sein d'une même agence, tous les savoir-faire essentiels de la communication moderne : <strong className="text-zinc-900 dark:text-zinc-100">conseil stratégique, production audiovisuelle, technologie scénique, design, digital et intelligence artificielle.</strong>
            </p>
            ...
            <p>
              <strong className="text-zinc-900 dark:text-zinc-100">Notre différence : la cohérence.</strong>
            </p>
            <p>
              Chaque pôle parle le même langage et travaille en synergie pour garantir un parcours fluide, du concept à la diffusion.
            </p>
          </div>
        </div>
      </ThemeSection>
      ...
      <ThemeSection variant="light" className="py-20 bg-zinc-50 dark:bg-zinc-900/30">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-center text-lg text-zinc-700 dark:text-zinc-300 max-w-3xl mx-auto mb-16">
            Nos six pôles d'expertise sont indépendants mais interconnectés. Ils peuvent être activés séparément ou intégrés dans un dispositif global, selon votre stratégie et vos priorités.
          </p>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b-2" style={{ borderColor: '#7C3AED' }}>
                  <th className="text-left py-4 px-6 text-lg font-semibold text-zinc-900 dark:text-zinc-100">Pôle</th>
              ...
              <tbody className="divide-y divide-zinc-200 dark:divide-zinc-700">
                {[
                  ...
                  },
                  {
                    ...
                    objectif: "Construire votre identité visuelle et renforcer votre univers de marque.",
                  ...
                  <tr key={i} className="hover:bg-zinc-50 dark:hover:bg-zinc-900/30 transition-colors">
                    <td className="py-4 px-6 font-semibold text-zinc-900 dark:text-zinc-100">{row.pole}</td>
      ...
      <ThemeSection variant="light" className="py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <blockquote className="border-l-4 pl-6 py-4 text-zinc-600 dark:text-zinc-400 italic text-xl mt-8 text-center max-w-3xl mx-auto" style={{ borderColor: '#7C3AED' }}>
            « Nous concevons chaque projet comme un parcours intelligent, où chaque action nourrit la suivante. »
          </blockquote>
        </div>
      </ThemeSection>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto space-y-6 text-lg text-zinc-700 dark:text-zinc-300 mb-12">
            <p className="text-center">
              Ce modèle intégré permet à Nouvelle Ère Digital de :
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-12">
            {[
              ...
              <div key={i} className="flex gap-4 items-start card">
                <div className="w-6 h-6 rounded-full flex-shrink-0 flex items-center justify-center text-white text-sm font-bold" style={{ backgroundColor: '#7C3AED' }}>
                  ✓
                </div>
          ...
          <p className="text-center text-lg text-zinc-700 dark:text-zinc-300 max-w-3xl mx-auto">
            Nos équipes partagent la même culture : <strong className="text-zinc-900 dark:text-zinc-100">créative, technologique et humaine.</strong>
          </p>
        </div>
      </ThemeSection>
      ...
      <ThemeSection variant="light" className="py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto space-y-6 text-lg text-zinc-700 dark:text-zinc-300 text-center">
            <p>
              Nos pôles sont portés par des professionnels aguerris : <strong className="text-zinc-900 dark:text-zinc-100">créatifs, ingénieurs, réalisateurs, designers, développeurs, formateurs et techniciens événementiels.</strong>
            </p>
            <p>
              Tous animés par une exigence commune : faire de chaque projet une expérience fluide, inspirante et mesurable.
            </p>
              ...
              <div key={i} className="card group hover:shadow-lg transition-shadow">
                <div className="flex gap-4 items-start">
                  <div className="flex-shrink-0">
                    <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #7C3AED, #6D28D9)' }}>
      ...
      <ThemeSection variant="light" className="py-20">
        <div className="max-w-6xl mx-auto">
          ...
          />
          <p className="text-center text-lg text-zinc-700 dark:text-zinc-300 max-w-3xl mx-auto mb-16">
            Notre approche modulaire s'adapte à la taille, au rythme et à la maturité numérique de chaque client :
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              <div key={i} className="card text-center group hover:shadow-lg transition-shadow">
                ...
                <h3 className="text-xl font-semibold text-zinc-900 dark:text-zinc-100 mb-3">{item.title}</h3>
                <p className="text-zinc-600 dark:text-zinc-400">{item.desc}</p>
              </div>
            ))}
          </div>
      ...
      <ThemeSection variant="dark" className="py-20">
        <div className="max-w-4xl mx-auto text-center">
          <blockquote className="text-2xl md:text-3xl font-medium text-white leading-relaxed">
            « Nous faisons converger stratégie, design, technologie et IA pour créer un impact durable. »
          </blockquote>
        </div>
      </ThemeSection>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-zinc-700 dark:text-zinc-300 max-w-2xl mx-auto">
              De l'audiovisuel au digital, de la scène aux données IA, nous créons des synergies qui amplifient votre impact.
            </p>
          </div>
          ...
          <div className="text-center mt-12">
            <div className="inline-flex items-center justify-center gap-3 px-6 py-3 rounded-full" style={{ background: 'linear-gradient(135deg, rgba(124,58,237,0.2), rgba(124,58,237,0.05))' }}>
              <div className="w-3 h-3 rounded-full animate-pulse" style={{ backgroundColor: '#7C3AED' }}></div>
              <span className="text-sm font-medium text-zinc-900 dark:text-zinc-100">Interconnexion & Synergie</span>
              <div className="w-3 h-3 rounded-full animate-pulse" style={{ backgroundColor: '#7C3AED' }}></div>
            </div>
          </div>
        </div>
      ...
      <ThemeSection variant="light" className="py-32 bg-zinc-50 dark:bg-zinc-900/30">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-zinc-600 dark:text-zinc-400 mb-10 max-w-2xl mx-auto">
            Découvrez comment chaque pôle peut transformer votre communication et composez votre parcours sur mesure.
          </p>
