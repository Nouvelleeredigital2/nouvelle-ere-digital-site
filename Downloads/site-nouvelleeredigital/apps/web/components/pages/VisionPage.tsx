    ...
    <>
      ...
      <ThemeSection variant="light" className="py-20">
        <div className="max-w-4xl mx-auto">
          <div className="max-w-3xl mx-auto space-y-6 text-lg text-foreground">
            <p>
              Le monde numérique évolue à une vitesse vertigineuse. Technologies, usages, attentes :
              tout change.
            </p>
            <p>
              Mais au milieu de cette accélération, une conviction demeure :{" "}
              <strong className="text-foreground">
                la technologie n&apos;a de valeur que si elle sert la créativité, la performance et
                la relation humaine.
              </strong>
            </p>
            <p>
              C'est dans cet esprit que Nouvelle Ère Digital est née : une agence qui unit la
              puissance de l'innovation à la sensibilité du design, à la rigueur du conseil et à
              l'émotion de l'audiovisuel.
            </p>
            <blockquote
      ...
      <ThemeSection variant="light" className="py-20 bg-muted">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto space-y-6 text-lg text-foreground text-center">
            <p>
              Nous incarnons une nouvelle génération d'agences :{" "}
              <strong className="text-foreground">
                transversales, responsables, créatives et augmentées par l&apos;intelligence
                artificielle.
              </strong>
            </p>
            <p>
              Notre ambition est simple : transformer les idées en expériences de marque
              engageantes, mesurables et durables.
            </p>
            <div className="pt-6">
              <p className="font-medium text-foreground mb-4">
                Nous croyons qu&apos;un projet réussi est celui qui :
              </p>
              <div className="grid md:grid-cols-3 gap-6 mt-8">
                <div className="text-center">
                  <div
                    className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-brand/20 to-brand/5 flex items-center justify-center"
                    style={{
                      background:
            ...
            <p className="font-semibold text-foreground text-xl pt-8">
              ...
              <div className="flex flex-col md:flex-row gap-6 items-start">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-lg text-foreground mb-4">
                    Rendre la technologie accessible, lisible et utile. Nous concevons des
                    dispositifs où la technique s'efface derrière l'expérience utilisateur.
                  </p>
                  <p className="text-muted-foreground">
                    Notre approche : clarté, fluidité et pédagogie — pour que l'innovation soit un
                    levier, pas un labyrinthe.
                  </p>
                  <blockquote
                    className="mt-4 pl-4 border-l-2 italic text-muted-foreground"
                    style={{ borderColor: "#7C3AED" }}
                  >
            ...
            <div className="card group hover:shadow-lg transition-shadow">
              <div className="flex flex-col md:flex-row gap-6 items-start">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-lg text-foreground mb-4">
                    Explorer de nouvelles formes d'expression et d'interaction. Chaque projet est un
                    laboratoire d'idées, nourri par la veille technologique, la créativité
                    collective et la recherche de sens.
                  </p>
                  <p className="text-muted-foreground">
                    Nous expérimentons les nouveaux usages de l'IA, du digital et de la data pour
                    créer de la valeur réelle, pas des effets de mode.
                  </p>
                  <blockquote
                    className="mt-4 pl-4 border-l-2 italic text-muted-foreground"
                    style={{ borderColor: "#7C3AED" }}
                  >
                    « L'innovation n'est pas un gadget : c'est la capacité à imaginer mieux,
                    ensemble. »
                  </blockquote>
                </div>
              </div>
            ...
            <div className="card group hover:shadow-lg transition-shadow">
              <div className="flex flex-col md:flex-row gap-6 items-start">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-lg text-foreground mb-4">
                    Chaque projet commence par une écoute et se construit dans la confiance. Nous
                    mettons la technologie au service des talents, des émotions et des histoires qui
                    rapprochent.
                  </p>
                  <p className="text-muted-foreground">
                    Car derrière chaque écran, il y a des regards, des voix, des équipes — et c'est
                    là que se trouve notre véritable moteur.
                  </p>
                  <blockquote
                    className="mt-4 pl-4 border-l-2 italic text-muted-foreground"
                    style={{ borderColor: "#7C3AED" }}
      ...
      <ThemeSection variant="light" className="py-20 bg-muted">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto space-y-6 text-lg text-foreground text-center">
            <p>
              Être le partenaire unique capable de relier la stratégie, la créativité et la
              technologie pour bâtir des expériences de communication qui ont du sens.
            </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto space-y-6 text-lg text-foreground">
            <p className="text-center">
              Chez Nouvelle Ère Digital, l'intelligence artificielle est une force d'amplification
              créative et opérationnelle.
            </p>
            <p className="text-center">
              Nous l'intégrons là où elle simplifie, automatise ou enrichit — jamais là où elle
              déshumanise.
            </p>
            <div className="grid md:grid-cols-3 gap-6 mt-8">
              {[
            ...
            <p className="font-semibold text-foreground text-center pt-6">
      ...
      <ThemeSection variant="light" className="py-20 bg-muted">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto space-y-6 text-lg text-foreground text-center">
            <p>
              Notre démarche s'appuie sur la transparence, la pédagogie et la souveraineté
              numérique.
            </p>
            <p>
              Chaque solution respecte le{" "}
              <strong className="text-foreground">RGPD, l&apos;AI Act</strong> et
              les normes de sécurité les plus exigeantes.
            </p>
            <p>
              Nos infrastructures sont hébergées en Europe, nos données maîtrisées, nos processus
              documentés.
            </p>
            <blockquote
              className="border-l-4 pl-6 py-4 text-muted-foreground italic text-xl mt-8"
      ...
      <ThemeSection variant="light" className="py-20">
        <div className="max-w-4xl mx-auto text-center">
          <blockquote className="text-2xl md:text-3xl font-medium text-foreground leading-relaxed">
            « Nous croyons qu'un projet numérique n'a de sens que s'il éclaire, relie et valorise
      ...
      <ThemeSection variant="dark" className="py-32">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-semibold tracking-tight text-card-foreground mb-6">
