      ...
      <ThemeSection variant="light" className="py-20">
        <div className="max-w-4xl mx-auto">
          <div className="max-w-3xl mx-auto space-y-6 text-lg text-zinc-700 dark:text-zinc-300">
            ...
            <p>
              Notre pôle Communication & Marketing Digital conçoit des stratégies puissantes,
              incarnées et mesurables.
            </p>
            <p>
              De la définition du positionnement à la production de contenus, nous orchestrons la
              ...
              <div className="flex flex-col md:flex-row gap-6 items-start">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-lg text-zinc-700 dark:text-zinc-300 mb-4">
                    ...
                    Intégration de solutions IA pour l&apos;analyse prédictive des performances.
                    Création de contenus natifs : vidéos, carrousels, motion design, podcasts,
                    infographies.
                  </p>
                  <blockquote
                    className="border-l-2 pl-4 py-2 italic text-zinc-600 dark:text-zinc-400"
          ...
          <div className="overflow-x-auto">
            <table className="w-full max-w-4xl mx-auto">
              ...
              <tbody className="divide-y divide-zinc-200 dark:divide-zinc-700">
                {[
                  {
                    benefice: "Stratégie claire et pilotée",
                    impact: "Vision unifiée, cohérence éditoriale.",
                  },
                  {
                    benefice: "Création de contenu ciblée",
                    impact: "Engagement accru et meilleure conversion.",
                  },
                  {
                    benefice: "Campagnes mesurables",
                    impact: "Indicateurs clairs et reporting transparent.",
                  },
                  {
                    benefice: "Automatisation intelligente",
                    impact: "Gain de temps et optimisation continue.",
                  },
                  {
                    benefice: "Équipe intégrée",
                    impact: "Un interlocuteur unique, réactif et expert.",
                  },
                ].map((row, i) => (
                  <tr
                    key={i}
