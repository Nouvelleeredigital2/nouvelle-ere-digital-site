    ...
    <div className="space-y-8">
            ...
            >
              ...
              >
                ...
                <div className="grid grid-cols-4 gap-2 mb-4">
                  {Object.entries(theme.colors).slice(0, 8).map(([colorKey, colorValue]) => (
                    <div
                      key={colorKey}
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <ul className="text-sm text-muted-foreground space-y-2">
              <li>• <strong>Contraste Élevé</strong> : Idéal pour les présentations ou les environnements très lumineux</li>
              <li>• <strong>Clair</strong> : Parfait pour une utilisation quotidienne avec une excellente lisibilité</li>
              <li>• <strong>Sombre</strong> : Agréable pour les yeux en soirée ou dans des environnements sombres</li>
              <li>• <strong>Système</strong> : S'adapte automatiquement aux préférences de votre appareil</li>
            </ul>
          </div>
        </div>
      </Card>
      ...
      <AnimatePresence>
        {previewMode && (
          ...
          >
            Aperçu du thème {contrastThemes[previewMode as keyof typeof contrastThemes]?.name} - {5 - Math.floor((Date.now() % 5000) / 1000)}s restantes
          </motion.div>
        )}
      </AnimatePresence>
    </div>
